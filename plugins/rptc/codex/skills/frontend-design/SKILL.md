...
**SOP Reference**: `sop/frontend-guidelines.md` in the RPTC plugin — accessibility (WCAG 2.1 AA), responsive breakpoints, performance metrics, component patterns, form design, error handling, loading states. These engineering standards apply to all frontend work regardless of aesthetic direction.
