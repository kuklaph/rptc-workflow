...
- Provider-native plan file when available
- Steps tracked via `update_plan` during TDD execution when available
...
1. **Standard Operating Procedures** - Consult the RPTC plugin `sop/[name].md`:
