...
**Arguments**:
- None: `rptc:rptc-commit` - Commit only
- With PR: `rptc:rptc-commit pr` - Commit and create pull request
...
|-------|-------------------|-----------------|
| Git workflow | Project `sop/`, `Codex global guidance` | `RPTC plugin root/sop/git-and-deployment.md` |
...
**Trigger**: User invoked `rptc:rptc-commit pr`
